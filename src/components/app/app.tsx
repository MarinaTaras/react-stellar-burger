    ...
    <div className={styles.app}>
      <div className={styles.page}>
        ...
        <Routes location={background || location}>
          ...
          <Route path="/profile" element={<OnlyAuth component={<ProfilePage />} onlyUnAuth={false} />} >
            <Route path="profile" element={<EditProfile />} />
            <Route path="orders" element={<AuthOrdersHistory />} />
          </Route >
          <Route path="/profile/orders/:id" element={<OnlyAuth component={<AuthOrderInfo />} onlyUnAuth={false} />} />
