...
function ResetpasswordPage() {
  ...
  function onResetClick(e: MouseEvent<HTMLFormElement>) {
    e.preventDefault()
    postReset(form)
    ...
    <div className={styles.wrapper}>
      <form className={styles.form} onSubmit={onResetClick} >
        ...
        <fieldset className={styles.form_fieldset}>
          <PasswordInput name={'password'} placeholder={'Введите новый пароль'} onChange={onInputChange} value={form.password} size={'default'} extraClass="mb-2" />
